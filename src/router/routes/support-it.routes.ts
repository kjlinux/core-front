    ...
    children: [
      {
        ...
        meta: { title: 'Support IT — Dashboard', roles: [UserRole.SUPPORT_IT, UserRole.SUPER_ADMIN] },
      },
      {
        path: 'health',
        name: 'support-health',
        component: () => import('@/pages/support-it/SystemHealthPage.vue'),
        meta: { title: 'Sante systeme', roles: [UserRole.SUPPORT_IT, UserRole.SUPER_ADMIN] },
      },
      {
        path: 'devices',
      ...
      },
      {
        ...
        meta: { title: 'Detail capteur', roles: [UserRole.SUPPORT_IT, UserRole.SUPER_ADMIN] },
      },
      {
        path: 'witnesses',
        name: 'support-witnesses',
        component: () => import('@/pages/support-it/WitnessDevicesPage.vue'),
        meta: { title: 'Capteurs temoins', roles: [UserRole.SUPPORT_IT, UserRole.SUPER_ADMIN] },
      },
      {
        path: 'alerts',
        name: 'support-alerts',
