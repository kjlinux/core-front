...
// Pour les rôles à menu court (Support IT, Employe), la sidebar reste dépliée
// quel que soit l'état du store.
const collapsed = computed(() => canCollapseSidebar.value && ui.sidebarCollapsed)
